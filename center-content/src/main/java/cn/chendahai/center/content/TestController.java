...
import cn.chendahai.center.content.feignclient.TestBaiduFeignClient;
import cn.chendahai.center.content.feignclient.TestUserCenterFeignClient;
import cn.chendahai.center.content.sentineltest.TestControllerBlockHandlerClass;
...
public class TestController {
    ...
    public String testStream() {
        boolean hello = source.output().send(MessageBuilder.withPayload("hello").build());
        if (hello) {
            return "success";
        } else {
            return "failed";
